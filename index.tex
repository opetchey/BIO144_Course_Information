...
copy may not exactly match the most current version. If content changes
in an important way Owen will make an announcement on OLAT, or by email.
...
The website was written using a type of RMarkdown. It allows a script
with a mix of normal text and R code to produce chapters and a book that
has a mixture of text, R code, and R output. Rmarkdown is very useful
for making reports, books, presentations, and even websites.
...
\href{https://opetchey.github.io/BIO144_Course_Information/3.1-learning-objectives.html}{The
...
are sometimes not so sure, perhaps because its new.) Your laptop must be
able to connect to the wireless internet at UZH.
...
\item
  A spreadsheet programme, such as Microsoft Excel, Apple Numbers, or
  OpenOffice.
\item
...
problems, no worries\ldots{} ask for help during the first practical.

\section*{RStudio server}\label{rstudio-server}
\addcontentsline{toc}{section}{RStudio server}

\markright{RStudio server}

In the final exam you will have to use RStudio server. You are welcome
to use it during the course also. You can access it at the following
URL: \url{https://rstudio.mnf.uzh.ch/}. You can log in with your UZH
...
\textbf{Datasets used in the homework and practical} are available as a
zip file here:
...
\textbf{Datasets used in the course book} are available in a different
zip file, which is provided in the course book (Preface).

\textbf{Datasets associated with the book Getting Started with R}, by
...
\textbf{Attending class is a really good idea!}:

``\emph{attendance {[}is{]} a better predictor of college grades than
any other known predictor of academic performance}'',

Credé, Roch, \& Kieszczynka, 2010.
...
During approximately two weeks there is no new content. During these
week you should take the opportunity to consolidate, review, reinforce,
expand!
...
\item
  ...
  you may put information on both sides of.
\item
...
\item
  ...
  you have enough battery power to last the exam.
\item
...
\item
  From within the Safe Exam Browser you will be able to use RStudio
  Server.
\item
...
\section*{Important information about the ``mandatory practice exam
experience''}\label{important-information-about-the-mandatory-practice-exam-experience}
\addcontentsline{toc}{section}{Important information about the
``mandatory practice exam experience''}

\markright{Important information about the ``mandatory practice exam
experience''}

This experience is mandatory so that we and you can know that the exam
system works on your computer, and if not we can fix any issues before
the examination. It also gives you experience of the system. Do not use
the number and type of different types of question as an indicator of
anything about the final exam.
...
as soon as possible. The following guidelines will help you get fast and
...
Of course, please feel free to email Owen directly if you wish (but he
may ask you to post on the Forum if he feels that would be better).
...
directly. We will then contact Prof.~Furrer and feedback the answer to
you.
...
Some example solution scripts can be found here at the link below.
However, in 2026 these are not necessarily up to date, so please beware.
Also, please control your use of these example scripts carefully.
Students in previous years have said they felt that they sometimes
looked at the solutions to early or too quickly. They are provided
because many students over many years have asked for them.
...
\textbf{Mandatory practice examination experience}: Date and time to be
communicated

\textbf{Final Examination date and time}: Please see this Studium
Biology, Modulprufungen im Grundstudium web page and the links therein
for the examination dates and other important examination information.
...
The learning objective are what you must know (i.e., could appear in the
exam). As well the ``must know'' being described in the learning
objectives, the content of each chapter of the course book is ``must
know''.
...
\section*{Unit-level learning
objectives}\label{unit-level-learning-objectives}
\addcontentsline{toc}{section}{Unit-level learning objectives}

\markright{Unit-level learning objectives}
...
\item
  ...
  data.
\item
  Perform ANOVA in R, assess model assumptions, and interpret results in
...
\item
  Describe the key components of a generalised linear model (GLM): the
  linear predictor, the distribution family, and the link function.
\item
...
\subsection*{Mixed models and what
next}\label{mixed-models-and-what-next}
\addcontentsline{toc}{subsection}{Mixed models and what next}

\subsubsection*{Part 1: Mixed models}\label{part-1-mixed-models}
\addcontentsline{toc}{subsubsection}{Part 1: Mixed models}
...
\subsubsection*{Part 2: What next?}\label{part-2-what-next}
\addcontentsline{toc}{subsubsection}{Part 2: What next?}
...
\href{assets/Week1_lecture_slides.pdf}{Here are the slides for the
lecture.}.
...
Available
\href{https://rstudio.mnf.uzh.ch:3939/content/1913b078-b142-457f-8f08-8d66cc562490}{here}.
You will need to be on a UZH network to access this link, so if you are
not on campus, you will need to connect to the UZH VPN first.
...
Available
\href{https://rstudio.mnf.uzh.ch:3939/content/415e9279-c26a-4756-8570-fb1f9daab65c}{here}.
You will need to be on a UZH network to access this link, so if you are
not on campus, you will need to connect to the UZH VPN first.
...
Available
\href{https://rstudio.mnf.uzh.ch:3939/content/b448ba8b-4d13-4e69-83ed-4250a8bada0c}{here}.
You will need to be on a UZH network to access this link, so if you are
not on campus, you will need to connect to the UZH VPN first.
...
Available
\href{https://rstudio.mnf.uzh.ch:3939/content/d6c3f6eb-c513-44c8-af74-d3db7f4d00a7}{here}.
You will need to be on a UZH network to access this link, so if you are
not on campus, you will need to connect to the UZH VPN first.
...
Available
\href{https://rstudio.mnf.uzh.ch:3939/content/550e6fb0-423a-4087-9bb2-49e9be0a86c7}{here}.
You will need to be on a UZH network to access this link, so if you are
not on campus, you will need to connect to the UZH VPN first.
...
Available
\href{https://rstudio.mnf.uzh.ch:3939/content/63692bfe-bf6e-442f-a216-b676b85bb663}{here}.
You will need to be on a UZH network to access this link, so if you are
not on campus, you will need to connect to the UZH VPN first.
